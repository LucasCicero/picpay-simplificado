...
class TransactionServiceTest {
    ...
    @BeforeEach// método sempre executado antes dos testes unitários
    void setup(){
        MockitoAnnotations.initMocks(this);// iniciar os mocks do mockito
    }

    @Test
    @DisplayName("Should create transaction successfully when everything is OK")
    void createTransactionCaseTrue() throws Exception {
    ...
    void createTransactionCaseFalse() throws Exception {
        User sender = new User(1L, "Maria", "Souza", "99999999901", "maria@gmail.com", "12345", new BigDecimal(10), UserType.COMMON);
        User receiver = new User(2L, "Joao", "Souza", "99999999902", "joao@gmail.com", "12345", new BigDecimal(10), UserType.COMMON);
